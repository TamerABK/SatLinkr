...
if __name__=='__main__':
    print(
        SWPRfilter(
            "D:\Etudiant 5\Bureau\TAMER\satelliteImageryApp\data\GOSAT\SWPR\GOSAT2TFTS220230324_02SWPRV0210010017.h5",
            "CO2", "1590",
            datetime(day=24,month=3,year=2023,hour=12,minute=1), 1440,
            0,0,100000
        )
    )
